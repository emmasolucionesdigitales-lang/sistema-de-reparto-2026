...
function PlanillaDelDia({dia,fecha,ventas,clientes,prospectos,planilla,productos,stock,setStock,syncData,onGuardar,onVolver,onCerrarDia,initCierre,noVisitas,cargasDia}) {
  ...
  const prestadosDia={soda:0,b10:0,b20:0},devueltosDia={soda:0,b10:0,b20:0};
  ventas.forEach(v=>{
  ...
  const confirmarCierre = () => {
    ...
    ["soda","b10","b20"].forEach(pk=>{
      ...
      const dl=llenTotal-sobrantes[pk]; const dv=vacReal-vaciosRec[pk];
      ...
      <div style={s.screen}>
        ...
        <div style={{padding:16}}>
          ...
          <div style={{display:"flex",gap:8,marginTop:4}}>
            ...
            <button style={{flex:1,padding:"14px 8px",borderRadius:10,border:"none",background:"var(--color-background-tertiary)",borderTop:"2px solid #4dd9a0",color:"#4dd9a0",fontSize:13,fontWeight:700,cursor:"pointer"}}
