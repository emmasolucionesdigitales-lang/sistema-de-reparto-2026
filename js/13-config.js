...
function NotifConfig({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    ...
    resumen: (() => {
      try {
        const a = JSON.parse(localStorage.getItem('sr_horas_notif_trans') || '["13:00","19:00"]');
        return a[0] + ' y ' + a[1];
      } catch {
    ...
    defaultValue: (() => {
      try {
        return JSON.parse(localStorage.getItem('sr_horas_notif_trans') || '["13:00","19:00"]')[0];
      } catch {
        return '13:00';
      }
    })(),
    onChange: e => {
      let arr;
      try {
        arr = JSON.parse(localStorage.getItem('sr_horas_notif_trans') || '["13:00","19:00"]');
      } catch {
        arr = ['13:00', '19:00'];
      }
      arr[0] = e.target.value;
      localStorage.setItem('sr_horas_notif_trans', JSON.stringify(arr));
      syncData({
        horasAvisoTrans: arr
      });
    }
    ...
    defaultValue: (() => {
      try {
        return JSON.parse(localStorage.getItem('sr_horas_notif_trans') || '["13:00","19:00"]')[1];
      } catch {
        return '19:00';
      }
    })(),
    ...
    resumen: localStorage.getItem('sr_dias_notif_mant') || '3,2,1,0'
  }, /*#__PURE__*/React.createElement("input", {
    type: "text",
    ...
    resumen: localStorage.getItem('sr_hora_notif_cierre') || '18:00'
  }, /*#__PURE__*/React.createElement("input", {
    type: "time",
    style: {
      padding: "8px 10px",
    ...
    onChange: e => {
      localStorage.setItem('sr_hora_notif_cierre', e.target.value);
      syncData({
...
function Config({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "📦 Stock en depósito")), [["soderia", "🏭 Sodería"], ["casa", "🏠 Casa"], ["camion", "🚚 Camión"]].map(([lugar, titulo]) => /*#__PURE__*/React.createElement("div", {
    key: lugar,
    style: {
      ...s.card,
      margin: "0 0 12px"
  ...
  }, "Cantidades con las que salís cada día (cajones de soda = 6 sifones c/u)."), DIAS.map(function (dia) {
  ...
  }, "Guardá todos los datos en un archivo. Descargalo seguido y guardalo en otro lado (mail, Drive). Si se pierde el celular, lo restaurás y recuperás todo."), /*#__PURE__*/React.createElement("button", {
    style: {
      ...s.btnPrimary,
      width: "100%",
      marginBottom: 8
  ...
  }, "Importar clientes")), /*#__PURE__*/React.createElement("label", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
      ...
      fontSize: 13,
      cursor: importandoClientes ? "wait" : "pointer",
      boxSizing: "border-box"
    }
  }, importandoClientes ? "⏳ Leyendo archivo..." : "📥 Importar clientes desde Excel", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: ".xlsx,.xls",
    style: {
      display: "none"
    ...
    onChange: e => {
      ...
      const procesarBuffer = buffer => {
        try {
          ...
          if (pendientesActualizar.length > 0) {
            const msg = countNuevos > 0 ? `✅ ${countNuevos} cliente${countNuevos > 1 ? "s" : ""} nuevo${countNuevos > 1 ? "s" : ""}.\n⚠️ ${pendientesActualizar.length} ya exist${pendientesActualizar.length > 1 ? "en" : "e"}.\n\n¿Actualizar los existentes con los datos del Excel?` : `⚠️ Los ${pendientesActualizar.length} cliente${pendientesActualizar.length > 1 ? "s" : ""} del archivo ya existen en la app.\n\n¿Actualizar sus datos con los del Excel?`;
            if (window.confirm(msg)) {
              pendientesActualizar.forEach(({
                idx,
                datos
              }) => {
                nuevos[idx] = {
      ...
      const leer = () => {
        ...
        r.onload = ev => procesarBuffer(ev.target.result);
        r.onerror = () => {
  ...
  }, "Vinculado — datos se envían al cerrar el día")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8,
  ...
  }, "🗑️ Desvincular Emma Control"))), /*#__PURE__*/React.createElement("a", {
  ...
  }, "Los productos y stock se conservan")))), tab === "vehiculo" && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16
    }
  }, /*#__PURE__*/React.createElement("div", {
