      ...
      {tab==="datos"&&(
        <div style={{padding:16,display:"flex",flexDirection:"column",gap:10}}>
          ...
          <div style={{borderTop:"1px solid var(--color-border-secondary)",paddingTop:10}}>
            <div style={{fontSize:11,fontWeight:700,color:"var(--color-text-secondary)",textTransform:"uppercase",letterSpacing:"0.06em",marginBottom:8}}>🔗 Vincular con Emma Control</div>
            <input value={ecToken}
