// ════════════════════════════════════════════════════════════════════
// ◆  05-componentes.js — componentes de UI COMPARTIDOS entre pantallas:
//    PieEnvases, FormCliente, HeaderBotones, HeaderApp, CambioEnvasePanel,
//    FotoClienteModal, TipoRecordatorioSelector, FechaHoraRow.
//    Usan funciones/estilos definidos en 04-utils.js (carga antes que este).
// ════════════════════════════════════════════════════════════════════
// ════════════════════════════════════════════════════════════════════
