...
function DatosNegocioLC() {
  ...
  const guardarNombre = v => {
    setNombre(v);
    localStorage.setItem("sr_negocio_nombre", v);
    setGuardado(true);
  ...
  const subirLogo = async file => {
    ...
    setLogo(b64);
    localStorage.setItem("sr_negocio_logo", b64);
  };
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...s.card,
  ...
  }, "🏪 Datos del negocio"), /*#__PURE__*/React.createElement("label", {
    style: {
      ...s.label,
      marginBottom: 4
    }
  }, "Nombre (aparece arriba de todo)"), /*#__PURE__*/React.createElement("input", {
    style: s.input,
  ...
  }, logo ? "Cambiar" : "Subir logo", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "image/*",
    style: {
      display: "none"
    },
    onChange: e => subirLogo(e.target.files && e.target.files[0])
    ...
    onClick: () => {
      setLogo("");
      localStorage.removeItem("sr_negocio_logo");
    }
  }, "Quitar"))));
}
function ConfigAparienciaLC() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(DatosNegocioLC, null), /*#__PURE__*/React.createElement("div", {
    style: {
      ...s.card,
      marginBottom: 12,
      background: "var(--color-background-secondary)"
